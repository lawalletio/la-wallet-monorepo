    ...
    <>
      <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill={color}>
        <path
          ...
          clipRule='evenodd'
        ></path>
        <path d='M5 11.25h1.5v1.5H5zM8 11.25h1.5v1.5H8zM11.167 11.25h1.5v1.5h-1.5zM11.167 14.375h1.5v1.5h-1.5zM11.167 17.5h1.5V19h-1.5zM11.167 8.125h1.5v1.5h-1.5zM11.167 5h1.5v1.5h-1.5zM14.333 11.25h1.5v1.5h-1.5zM17.5 11.25H19v1.5h-1.5zM14.333 14.375h1.5v1.5h-1.5zM17.5 14.375H19v1.5h-1.5zM14.333 17.5h1.5V19h-1.5zM17.5 17.5H19V19h-1.5z'></path>
      </svg>
    </>
  );
}

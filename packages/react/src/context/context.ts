...
export const LaWalletProvider = (props: React.PropsWithChildren<ConfigParameter>) => {
    ...
    return React.createElement(NDKProvider, props, React.createElement(ConfigContext.Provider, configProps, React.createElement(AccountProvider, props, children)))
}